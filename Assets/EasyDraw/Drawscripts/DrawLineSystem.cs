...
public class DrawLineSystem : Singleton<DrawLineSystem>
{
    public UnityEvent OnNoNeedForDrawnLine;
    ...
    public List<GameObject> instantiatedLines;
    ...
    private void Start()
    {
        OnNoNeedForDrawnLine.AddListener(clearDrawnLines);
    }
    ...
    private void createDrawLine()
    {
        ...
        instantiatedLines.Add(currentLine);
